  ...
  <div class="navbar-wrapper">
    ...
    <div class="navbar-content">
      <ul class="pc-navbar">
        ...
        <li class="pc-item">
          <router-link :to="{name:'tutor.create'}" class="pc-link"><span class="pc-micon"><i
                class="ti ti-typography"></i></span><span class="pc-mtext">Tutores</span></router-link>
        </li>
        <li class="pc-item">
        ...
        <li class="pc-item">
          <a href="https://tablericons.com" class="pc-link" target="_blank"><span class="pc-micon"><i
                class="ti ti-plant-2"></i></span><span class="pc-mtext">Tabler</span><span class="pc-arrow"></span></a>
        </li>
